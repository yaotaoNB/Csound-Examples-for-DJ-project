...
csoundblog.com
Modified by Muthuswamy V(N14275867)
...
instr 2
    ...
    start_loop:
        ...
        irmin = 2
        irmax = 6
        iarand random irmin, irmax
        print iarand
        intrand = int(iarand)
        ires = 2^(intrand)
        ; Adds a random number to the resolution
        ; ==================================================
        ienv_fn = int(rnd(3)) + 1         
        istep_odds = rnd(0.5)
...
instr 3
    ...
    ; Output
    ; ==================================================
    ; Adds Reverb to the beat mangler output
    ; ==================================================
    aleft = aleft * a_amp
    arleft reverb aleft, .01
    aright = aright * a_amp
    arright reverb aright, .01
